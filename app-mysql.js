...
const { sequelize, testConnection, syncDatabase } = require('./config/database-mysql');
const { User, Teacher, Course, Classroom, Timetable } = require('./models');
...
async function startServer() {
    ...
    if (!connected) {
        ...
        console.log('💡 Make sure MySQL is running and create database: CREATE DATABASE smart_classroom;');
        process.exit(1);
    }
